...
*   otherwise you are not able to use regular expressions
*/
...
#include <stdlib.h>
	...
	//	use PCRE2 regex
	//	=> may also work on a linux like machine
	//
	//	this might not work, if you're working with
	//	an old compiler version
	#include <pcre2.h>
