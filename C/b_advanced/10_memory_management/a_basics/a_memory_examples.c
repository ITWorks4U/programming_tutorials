...
#ifdef __cplusplus
#error "This example is usually written in C and shall be build with a C compiler only. It may happen, that you'll receive warning(s), error(s) or undefined behavior(s)!"
#endif
