...
>   **NOTE**: *C++* also comes with expressions, like **and**, **or**, but those expressions are **not** in use for bit operations. Those are logical operations. Take a look into **Chapter 6** for more details. If you want to use a written out expression, then use **bitand**, **bitor**, ... instead.
