...
#include <iostream>
#include <ciso646>                                                              // required to use "and", "bitand", ... correctly
using namespace std;
...
int main() {
	...
	*/
	...
	//NOTE: The bit operations MUST be placed in brackets!

	cout << "a & b: " << (a & b) << endl;                                       // a AND b => 40
	cout << "a bitand b: " << (a bitand b) << endl;

	cout << "a | b: " << (a | b) << endl;                                       // a OR b => 9003
	cout << "a bitor b: " << (a bitor b) << endl;

	cout << "a ^ b: " << (a ^ b) << endl;                                       // a XOR b => 8963
	cout << "a xor b: " << (a xor b) << endl;

	cout << " ~a & b: " << (~a) << endl;                                        // NOT a => -43
	cout << "compl a: " << (compl a) << endl;

	cout << "~a & b: " << (~a & b) << endl;                                     // NOT a AND b => 8961
	cout << "((compl a) bitand b): " << ((compl a) bitand b) << endl;

	cout << "~(a & b): " << ~(a & b) << endl;                                   // NOT (a AND b) => NAND(a, b) => -41
	cout << "(compl (a bitand b)): " << (compl (a bitand b)) << endl;

	cout << "~a & ~b: " << (~a & ~b) << endl;                                   // NOT (a AND NOT b) => NOT a OR b => -3
	cout << "compl a bitand compl b: " << ((compl a) bitand (compl b)) << endl;

	cout << "~(a | b): " << ~(a | b) << endl;                                   // NOT a OR b => NOR(a, b) => -9004
	cout << "(compl (a bitor b)): " << (compl (a bitor b)) << endl;

	cout << "~(a ^ b): " << ~(a ^ b) << endl;                                   // NOT a XOR b => NXOR(a, b) => -8964
