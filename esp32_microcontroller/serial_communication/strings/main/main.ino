...
*
* NOTE: By handling the messages with C++ Strings this is a horrible
*       slow matchup, but this also shows you an easy way to handle
*       incoming and also outgoing messages.
*
* This setup requires:
